...
class JDBCMiddler{
  ...
  String r="";
    ...
    protected ArrayList<String> getSQL2(String SQL) throws Exception{
     StringBuffer html = new StringBuffer();
     ArrayList<String> v=new ArrayList<String>();
  ...
  String r="";
     ...
     protected ArrayList<String> getSQL3(String SQL) throws Exception{
     StringBuffer html = new StringBuffer();
     ArrayList<String> v=new ArrayList<String>();
  ...
  String r="";
    ...
    protected ArrayList<String> getSQL4(String SQL) throws Exception{
     StringBuffer html = new StringBuffer();
     ArrayList<String> v=new ArrayList<String>();
  ...
  String r="";
     ...
     protected ArrayList<String> getSQL5(String SQL) throws Exception{
     StringBuffer html = new StringBuffer();
     ArrayList<String> v=new ArrayList<String>();
