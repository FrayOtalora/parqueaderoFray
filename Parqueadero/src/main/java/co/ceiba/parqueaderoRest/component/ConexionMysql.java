...
public class ConexionMysql {
    ...
    private static String bd = "parqueadero";
    private static  String login = "root";
    private static  String password = "";
    private static  String url = "jdbc:mysql://localhost:3306/127.0.0.1/"+bd;
...
/**
     * Método que ejecuta una consulta en SQL
     * @param sql es de tipo String y contiene la consulta en sql
     * @return un tipo ArrayList sin - y contiene la informacion que retorna la consulta
     */
    public static java.util.ArrayList<String>  getConsultaSQL2(String sql) {
        
        try{
            
            return (jdbc.getSQL2(sql));
      ...
      public static java.util.ArrayList<String>  getConsultaSQL3(String sql) {
        
        try{
            
            return (jdbc.getSQL3(sql));
 ...
 public static java.util.ArrayList<String>  getConsultaSQL4(String sql) {
        
        try{
            
            return (jdbc.getSQL4(sql));
  ...
  /**
     ...
     * @return un tipo ArrayList y contiene la informacion que retorna la consulta
     */
    public static java.util.ArrayList<String>  getConsultaSQL5(String sql) {
        
        try{
            
            return (jdbc.getSQL5(sql));
